...
<script type="module">
    ...
    import { useServiceConf,useSlsConf,useRtmpConf,useNdiConf,useWebRTCConf } from "./assets/js/vue.hooks.js";
    ...
    const app = createApp({
        ...
        setup(props,context) {
            ...
            return {serviceConf,slsConf,rtmpConf,updateRtmpConf,ndiConf,updateNdiConf,saveSrtConf,webrtcConf,updateWebRTCConf}
        }
    });
