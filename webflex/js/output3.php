		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="title">
						<h3 class="panel-title">Output Config</h3>
					</div>
			...
			<div class="col-md-7">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div id="layout" style="position: relative; width: 100%; padding-bottom: 56.25%; background-color: #000;"><div id="templeLay" style="position: absolute; padding: 10px; width: 50%; height: 50%; border: 1px solid rgb(221, 221, 221); z-index: 0; background-color: rgb(128, 128, 128); display: block; left: 0%; top: 0%;">
								...
								<table style="width: 100%;">
									<tbody><tr>
										<td width="100%">
											<select onchange="update();" id="laySrc" class="form-control input-sm">
												<option cn="空" en="NULL" value="-1">NULL</option>
												<option value="0">HDMI</option><option value="4">Net3</option><option value="5">Net4</option><option value="6">NDI Recv</option><option value="7">Carousel</option><option value="8">ColorKey</option><option value="9">Mix</option></select>
										</td>
										<td>
